...
# def load_llm():
#     """Load Llama model once with context window."""
#     return Llama(model_path=str(MODEL_PATH), n_ctx=512)
...
#     model = load_llm()
#     for token in model.stream(prompt, max_tokens=max_tokens, temperature=temperature, top_p=top_p):
#         yield token["text"]
